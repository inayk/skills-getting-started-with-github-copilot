...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball fundamentals through drills and friendly games",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "ava@mergington.edu"],
    },
    "Drama Club": {
        "description": "Explore acting, stage production, and school performances",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions through experiments and teamwork",
